...
class GalleryController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func getData() {
        ...
        let postString = "clientId=" + String(Constants.CLIENT_ID) + "&accountId=" + String(iApp.sharedInstance.getId()) + "&accessToken=" + iApp.sharedInstance.getAccessToken() + "&fcm_regId=" + iApp.sharedInstance.getFcmRegId() + "&photoId=" + String(self.itemId) + "&profileId=" + String(self.profileId);
