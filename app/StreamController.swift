...
//  SocialApp
//
//  Created by Mac Book on 01.10.2018.
//  Copyright © 2018 raccoonsquare@gmail.com. All rights reserved.
//

import UIKit

class StreamController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func getData() {
        ...
        var request = URLRequest(url: URL(string: Constants.METHOD_GALLERY_STREAM)!, cachePolicy: .reloadIgnoringLocalCacheData, timeoutInterval: 60)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (item.getItemType() == Constants.ITEM_TYPE_VIDEO) {
            
            cell.photoView.image = UIImage(named: "ic_video_preview")
