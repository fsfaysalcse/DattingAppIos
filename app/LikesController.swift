...
class LikesController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getData() {
        ...
        var request = URLRequest(url: URL(string: Constants.METHOD_PROFILE_GET_LIKES)!, cachePolicy: .reloadIgnoringLocalCacheData, timeoutInterval: 60)
