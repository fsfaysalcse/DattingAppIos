...
//  Helper.swift
//
//  Created by Demyanchuk Dmitry on 24.01.20.
...
class Helper {
    ...
    static func createBodyWithParametersForVideo(parameters: [String: String]?, filePathKey: String?, imageDataKey: NSData, boundary: String) -> NSData {
