...
class SearchViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func preloadData() {
        ...
        let postString = "clientId=" + String(Constants.CLIENT_ID) + "&accountId=" + String(iApp.sharedInstance.getId()) + "&accessToken=" + iApp.sharedInstance.getAccessToken() + "&itemId=" + String(self.itemId) + "&gender=" + String(3) + "&photo=" + String(0) + "&online=" + String(0);
    ...
    func getData(searchText: String) {
        ...
        request.httpMethod = "POST"
        let postString = "clientId=" + String(Constants.CLIENT_ID) + "&accountId=" + String(iApp.sharedInstance.getId()) + "&accessToken=" + iApp.sharedInstance.getAccessToken() + "&fcm_regId=" + iApp.sharedInstance.getFcmRegId() + "&query=" + searchText + "&itemId=" + String(self.itemId) + "&userId=" + String(self.itemId) + "&gender=" + String(3) + "&photo=" + String(0) + "&online=" + String(0);
